...
#include "C:\NVPACK\android-ndk-r10e\sources\android\native_app_glue\android_native_app_glue.h"
#include <jni.h>

#ifdef LOG_TAG
#undef LOG_TAG
#endif
#define LOG_TAG "com_razerzone_store_sdk_engine_marmalade_InputView"
...
namespace com_razerzone_store_sdk_engine_marmalade_InputView
{
	...
	int InputView::InitJNI()
	{
		...
		{
			const char* strClass = "com/razerzone/store/sdk/engine/marmalade/InputView";
	...
	void InputView::JNIFind()
	{
...

		{
			...
			#endif
			_jmGetInstance = env->GetStaticMethodID(_jcInputView, strMethod, "()Lcom/razerzone/store/sdk/engine/marmalade/InputView;");
			if (_jmGetInstance)
			{
				#if ENABLE_VERBOSE_LOGGING
