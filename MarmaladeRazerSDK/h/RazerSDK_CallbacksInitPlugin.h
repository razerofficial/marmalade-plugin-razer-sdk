...
typedef struct s3eInitPluginSuccessEvent
{
} s3eInitPluginSuccessEvent;

typedef struct s3eInitPluginFailureEvent
{
	int m_errorCode;
	char m_errorMessage[1024];
} s3eInitPluginFailureEvent;
...
private:
	...
	s3eInitPluginSuccessEvent m_dataInitPluginSuccessEvent;
	s3eInitPluginFailureEvent m_dataInitPluginFailureEvent;
